...
以上描述是官网[[1\]](http://ts.xcatliu.com/introduction/what-is-typescript.html#link-1)对于 TypeScript 的定义。

它强调了 TypeScript 的两个最重要的特性——类型系统、适用于任何规模。

## TypeScript 的特性[§](http://ts.xcatliu.com/introduction/what-is-typescript.html#typescript-的特性)

### 类型系统[§](http://ts.xcatliu.com/introduction/what-is-typescript.html#类型系统)
...
- 函数是 JavaScript 中的一等公民[[2\]](http://ts.xcatliu.com/introduction/what-is-typescript.html#link-2)，可以赋值给变量，也可以当作参数或返回值。

这种灵活性就像一把双刃剑，一方面使得 JavaScript 蓬勃发展，无所不能，从 2013 年开始就一直蝉联最普遍使用的编程语言排行榜冠军[[3\]](http://ts.xcatliu.com/introduction/what-is-typescript.html#link-3)；另一方面也使得它的代码质量参差不齐，维护成本高，运行时错误多。

而 TypeScript 的类型系统，在很大程度上弥补了 JavaScript 的缺点。

#### TypeScript 是静态类型[§](http://ts.xcatliu.com/introduction/what-is-typescript.html#typescript-是静态类型)

类型系统按照「类型检查的时机」来分类，可以分为动态类型和静态类型。

动态类型是指在运行时才会进行类型检查，这种语言的类型错误往往会导致运行时错误。JavaScript 是一门解释型语言[[4\]](http://ts.xcatliu.com/introduction/what-is-typescript.html#link-4)，没有编译阶段，所以它是动态类型，以下这段代码在运行时才会报错：
...
#### TypeScript 是弱类型[§](http://ts.xcatliu.com/introduction/what-is-typescript.html#typescript-是弱类型)
...
### 适用于任何规模[§](http://ts.xcatliu.com/introduction/what-is-typescript.html#适用于任何规模)
...
事实上，就算你从来没学习过 TypeScript，你也可能已经在不知不觉中使用到了 TypeScript——在 VSCode 编辑器中编写 JavaScript 时，代码补全和接口提示等功能就是通过 TypeScript Language Service 实现的[[7\]](http://ts.xcatliu.com/introduction/what-is-typescript.html#link-7)：

![what-is-typescript-vscode](http://ts.xcatliu.com/assets/what-is-typescript-vscode.png)

一些第三方库原生支持了 TypeScript，在使用时就能获得代码补全了，比如 Vue 3.0[[8\]](http://ts.xcatliu.com/introduction/what-is-typescript.html#link-8)：

![what-is-typescript-vue](http://ts.xcatliu.com/assets/what-is-typescript-vue.png)

有一些第三方库原生不支持 TypeScript，但是可以通过安装社区维护的类型声明库[[9\]](http://ts.xcatliu.com/introduction/what-is-typescript.html#link-9)（比如通过运行 `npm install --save-dev @types/react` 来安装 React 的类型声明库）来获得代码补全能力——不管是在 JavaScript 项目中还是在 TypeScript 中项目中都是支持的：

![what-is-typescript-react](http://ts.xcatliu.com/assets/what-is-typescript-react.png)

由此可见，TypeScript 的发展已经深入到前端社区的方方面面了，任何规模的项目都或多或少得到了 TypeScript 的支持。

### 与标准同步发展[§](http://ts.xcatliu.com/introduction/what-is-typescript.html#与标准同步发展)

TypeScript 的另一个重要的特性就是坚持与 ECMAScript 标准[[10\]](http://ts.xcatliu.com/introduction/what-is-typescript.html#link-10)同步发展。
...
除了实现 ECMAScript 标准之外，TypeScript 团队也推进了诸多语法提案，比如可选链操作符（`?.`）[[11\]](http://ts.xcatliu.com/introduction/what-is-typescript.html#link-11)、空值合并操作符（`??`）[[12\]](http://ts.xcatliu.com/introduction/what-is-typescript.html#link-12)、Throw 表达式[[13\]](http://ts.xcatliu.com/introduction/what-is-typescript.html#link-13)、正则匹配索引[[14\]](http://ts.xcatliu.com/introduction/what-is-typescript.html#link-14)等。

## 总结[§](http://ts.xcatliu.com/introduction/what-is-typescript.html#总结)
...
## 附：TypeScript 的发展历史[§](http://ts.xcatliu.com/introduction/what-is-typescript.html#附typescript-的发展历史)
...
## 参考资料[§](http://ts.xcatliu.com/introduction/what-is-typescript.html#参考资料)
...
## 编辑器[§](http://ts.xcatliu.com/introduction/get-typescript.html#编辑器)
...
## 布尔值[§](http://ts.xcatliu.com/basics/primitive-data-types.html#布尔值)
...
## 数值[§](http://ts.xcatliu.com/basics/primitive-data-types.html#数值)
...
## 字符串[§](http://ts.xcatliu.com/basics/primitive-data-types.html#字符串)
...
## 参考[§](http://ts.xcatliu.com/basics/primitive-data-types.html#参考)
...
## 什么是任意值类型[§](http://ts.xcatliu.com/basics/any.html#什么是任意值类型)
...
## 任意值的属性和方法[§](http://ts.xcatliu.com/basics/any.html#任意值的属性和方法)
...
## 未声明类型的变量[§](http://ts.xcatliu.com/basics/any.html#未声明类型的变量)
...
## 参考[§](http://ts.xcatliu.com/basics/any.html#参考)
...
## 什么是类型推论[§](http://ts.xcatliu.com/basics/type-inference.html#什么是类型推论)
...
## 参考[§](http://ts.xcatliu.com/basics/type-inference.html#参考)
...
## 简单的例子[§](http://ts.xcatliu.com/basics/union-types.html#简单的例子)
...
## 参考[§](http://ts.xcatliu.com/basics/union-types.html#参考)
...
## 什么是接口[§](http://ts.xcatliu.com/basics/type-of-object-interfaces.html#什么是接口)
...
## 简单的例子[§](http://ts.xcatliu.com/basics/type-of-object-interfaces.html#简单的例子)
...
## 可选属性[§](http://ts.xcatliu.com/basics/type-of-object-interfaces.html#可选属性)
...
## 任意属性[§](http://ts.xcatliu.com/basics/type-of-object-interfaces.html#任意属性)
...
## 只读属性[§](http://ts.xcatliu.com/basics/type-of-object-interfaces.html#只读属性)
...
## 参考[§](http://ts.xcatliu.com/basics/type-of-object-interfaces.html#参考)
...
## 「类型 + 方括号」表示法[§](http://ts.xcatliu.com/basics/type-of-array.html#类型--方括号表示法)
...
## 数组泛型[§](http://ts.xcatliu.com/basics/type-of-array.html#数组泛型)
...
关于泛型，可以参考[泛型](http://ts.xcatliu.com/advanced/generics.html)一章。

## 用接口表示数组[§](http://ts.xcatliu.com/basics/type-of-array.html#用接口表示数组)
...
## 类数组[§](http://ts.xcatliu.com/basics/type-of-array.html#类数组)
...
关于内置对象，可以参考[内置对象](http://ts.xcatliu.com/basics/built-in-objects.html)一章。

## any 在数组中的应用[§](http://ts.xcatliu.com/basics/type-of-array.html#any-在数组中的应用)
...
## 参考[§](http://ts.xcatliu.com/basics/type-of-array.html#参考)
...
## 函数声明[§](http://ts.xcatliu.com/basics/type-of-function.html#函数声明)
...
## 函数表达式[§](http://ts.xcatliu.com/basics/type-of-function.html#函数表达式)
...
## 用接口定义函数的形状[§](http://ts.xcatliu.com/basics/type-of-function.html#用接口定义函数的形状)
...
## 可选参数[§](http://ts.xcatliu.com/basics/type-of-function.html#可选参数)
...
## 参数默认值[§](http://ts.xcatliu.com/basics/type-of-function.html#参数默认值)
...
## 剩余参数[§](http://ts.xcatliu.com/basics/type-of-function.html#剩余参数)
...
## 重载[§](http://ts.xcatliu.com/basics/type-of-function.html#重载)
...
## 参考[§](http://ts.xcatliu.com/basics/type-of-function.html#参考)
...
## 语法[§](http://ts.xcatliu.com/basics/type-assertion.html#语法)
...
## 类型断言的用途[§](http://ts.xcatliu.com/basics/type-assertion.html#类型断言的用途)

类型断言的常见用途有以下几种：

### 将一个联合类型断言为其中一个类型[§](http://ts.xcatliu.com/basics/type-assertion.html#将一个联合类型断言为其中一个类型)

[之前提到过](http://ts.xcatliu.com/basics/union-types.html#访问联合类型的属性或方法)，当 TypeScript 不确定一个联合类型的变量到底是哪个类型的时候，我们**只能访问此联合类型的所有类型中共有的属性或方法**：
...
### 将一个父类断言为更加具体的子类[§](http://ts.xcatliu.com/basics/type-assertion.html#将一个父类断言为更加具体的子类)
...
### 将任何一个类型断言为 `any`[§](http://ts.xcatliu.com/basics/type-assertion.html#将任何一个类型断言为-any)
...
### 将 `any` 断言为一个具体的类型[§](http://ts.xcatliu.com/basics/type-assertion.html#将-any-断言为一个具体的类型)
...
## 类型断言的限制[§](http://ts.xcatliu.com/basics/type-assertion.html#类型断言的限制)
...
## 双重断言[§](http://ts.xcatliu.com/basics/type-assertion.html#双重断言)
...
## 类型断言 vs 类型转换[§](http://ts.xcatliu.com/basics/type-assertion.html#类型断言-vs-类型转换)
...
## 类型断言 vs 类型声明[§](http://ts.xcatliu.com/basics/type-assertion.html#类型断言-vs-类型声明)
...
## 类型断言 vs 泛型[§](http://ts.xcatliu.com/basics/type-assertion.html#类型断言-vs-泛型)
...
## 参考[§](http://ts.xcatliu.com/basics/type-assertion.html#参考)
...
### npm 包[§](http://ts.xcatliu.com/basics/declaration-files.html#npm-包)
...
##### 混用 `declare` 和 `export`[§](http://ts.xcatliu.com/basics/declaration-files.html#混用-declare-和-export)
...
#### `export namespace`[§](http://ts.xcatliu.com/basics/declaration-files.html#export-namespace)
...
#### `export default`[§](http://ts.xcatliu.com/basics/declaration-files.html#export-default)
...
### UMD 库[§](http://ts.xcatliu.com/basics/declaration-files.html#umd-库)

既可以通过 `<script>` 标签引入，又可以通过 `import` 导入的库，称为 UMD 库。相比于 npm 包的类型声明文件，我们需要额外声明一个全局变量，为了实现这种方式，ts 提供了一个新语法 `export as namespace`。

#### `export as namespace`[§](http://ts.xcatliu.com/basics/declaration-files.html#export-as-namespace)
...
### 直接扩展全局变量[§](http://ts.xcatliu.com/basics/declaration-files.html#直接扩展全局变量)
...
### 在 npm 包或 UMD 库中扩展全局变量[§](http://ts.xcatliu.com/basics/declaration-files.html#在-npm-包或-umd-库中扩展全局变量)
...
#### `declare global`[§](http://ts.xcatliu.com/basics/declaration-files.html#declare-global)
...
### 模块插件[§](http://ts.xcatliu.com/basics/declaration-files.html#模块插件)

有时通过 `import` 导入一个模块插件，可以改变另一个原有模块的结构。此时如果原有模块已经有了类型声明文件，而插件模块没有类型声明文件，就会导致类型不完整，缺少插件部分的类型。ts 提供了一个语法 `declare module`，它可以用来扩展原有模块的类型。

#### `declare module`[§](http://ts.xcatliu.com/basics/declaration-files.html#declare-module)
...
### 声明文件中的依赖[§](http://ts.xcatliu.com/basics/declaration-files.html#声明文件中的依赖)
...
#### 三斜线指令[§](http://ts.xcatliu.com/basics/declaration-files.html#三斜线指令)
...
##### **书写**一个全局变量的声明文件[§](http://ts.xcatliu.com/basics/declaration-files.html#书写一个全局变量的声明文件)
...
##### **依赖**一个全局变量的声明文件[§](http://ts.xcatliu.com/basics/declaration-files.html#依赖一个全局变量的声明文件)
...
##### 拆分声明文件[§](http://ts.xcatliu.com/basics/declaration-files.html#拆分声明文件)
...
##### 其他三斜线指令[§](http://ts.xcatliu.com/basics/declaration-files.html#其他三斜线指令)
...
### 自动生成声明文件[§](http://ts.xcatliu.com/basics/declaration-files.html#自动生成声明文件)
...
## 发布声明文件[§](http://ts.xcatliu.com/basics/declaration-files.html#发布声明文件)
...
### 将声明文件和源码放在一起[§](http://ts.xcatliu.com/basics/declaration-files.html#将声明文件和源码放在一起)
...
### 将声明文件发布到 `@types` 下[§](http://ts.xcatliu.com/basics/declaration-files.html#将声明文件发布到-types-下)
...
## 参考[§](http://ts.xcatliu.com/basics/declaration-files.html#参考)
...
## ECMAScript 的内置对象[§](http://ts.xcatliu.com/basics/built-in-objects.html#ecmascript-的内置对象)
...
## DOM 和 BOM 的内置对象[§](http://ts.xcatliu.com/basics/built-in-objects.html#dom-和-bom-的内置对象)
...
## TypeScript 核心库的定义文件[§](http://ts.xcatliu.com/basics/built-in-objects.html#typescript-核心库的定义文件)
...
## 用 TypeScript 写 Node.js[§](http://ts.xcatliu.com/basics/built-in-objects.html#用-typescript-写-nodejs)
...
## 参考[§](http://ts.xcatliu.com/basics/built-in-objects.html#参考)
...
## 简单的例子[§](http://ts.xcatliu.com/advanced/type-aliases.html#简单的例子)
...
## 参考[§](http://ts.xcatliu.com/advanced/type-aliases.html#参考)
...
## 简单的例子[§](http://ts.xcatliu.com/advanced/string-literal-types.html#简单的例子)
...
## 参考[§](http://ts.xcatliu.com/advanced/string-literal-types.html#参考)
...
## 简单的例子[§](http://ts.xcatliu.com/advanced/tuple.html#简单的例子)
...
## 越界的元素[§](http://ts.xcatliu.com/advanced/tuple.html#越界的元素)
...
## 参考[§](http://ts.xcatliu.com/advanced/tuple.html#参考)
...
## 简单的例子[§](http://ts.xcatliu.com/advanced/enum.html#简单的例子)
...
## 手动赋值[§](http://ts.xcatliu.com/advanced/enum.html#手动赋值)
...
## 常数项和计算所得项[§](http://ts.xcatliu.com/advanced/enum.html#常数项和计算所得项)
...
## 常数枚举[§](http://ts.xcatliu.com/advanced/enum.html#常数枚举)
...
## 外部枚举[§](http://ts.xcatliu.com/advanced/enum.html#外部枚举)
...
## 参考[§](http://ts.xcatliu.com/advanced/enum.html#参考)
...
## 类的概念[§](http://ts.xcatliu.com/advanced/class.html#类的概念)
...
## ES6 中类的用法[§](http://ts.xcatliu.com/advanced/class.html#es6-中类的用法)

下面我们先回顾一下 ES6 中类的用法，更详细的介绍可以参考 [ECMAScript 6 入门 - Class](http://es6.ruanyifeng.com/#docs/class)。

### 属性和方法[§](http://ts.xcatliu.com/advanced/class.html#属性和方法)
...
### 类的继承[§](http://ts.xcatliu.com/advanced/class.html#类的继承)
...
### 存取器[§](http://ts.xcatliu.com/advanced/class.html#存取器)
...
### 静态方法[§](http://ts.xcatliu.com/advanced/class.html#静态方法)
...
## ES7 中类的用法[§](http://ts.xcatliu.com/advanced/class.html#es7-中类的用法)

ES7 中有一些关于类的提案，TypeScript 也实现了它们，这里做一个简单的介绍。

### 实例属性[§](http://ts.xcatliu.com/advanced/class.html#实例属性)
...
### 静态属性[§](http://ts.xcatliu.com/advanced/class.html#静态属性)
...
## TypeScript 中类的用法[§](http://ts.xcatliu.com/advanced/class.html#typescript-中类的用法)

### public private 和 protected[§](http://ts.xcatliu.com/advanced/class.html#public-private-和-protected)
...
### 参数属性[§](http://ts.xcatliu.com/advanced/class.html#参数属性)
...
### readonly[§](http://ts.xcatliu.com/advanced/class.html#readonly)
...
### 抽象类[§](http://ts.xcatliu.com/advanced/class.html#抽象类)
...
## 类的类型[§](http://ts.xcatliu.com/advanced/class.html#类的类型)
...
## 参考[§](http://ts.xcatliu.com/advanced/class.html#参考)
...
## 类实现接口[§](http://ts.xcatliu.com/advanced/class-and-interfaces.html#类实现接口)
...
## 接口继承接口[§](http://ts.xcatliu.com/advanced/class-and-interfaces.html#接口继承接口)
...
## 接口继承类[§](http://ts.xcatliu.com/advanced/class-and-interfaces.html#接口继承类)
...
## 参考[§](http://ts.xcatliu.com/advanced/class-and-interfaces.html#参考)
...
## 简单的例子[§](http://ts.xcatliu.com/advanced/generics.html#简单的例子)
...
上例中，我们使用了[之前提到过的数组泛型](http://ts.xcatliu.com/basics/type-of-array.html#数组泛型)来定义返回值的类型。
...
## 多个类型参数[§](http://ts.xcatliu.com/advanced/generics.html#多个类型参数)
...
## 泛型约束[§](http://ts.xcatliu.com/advanced/generics.html#泛型约束)
...
## 泛型接口[§](http://ts.xcatliu.com/advanced/generics.html#泛型接口)

[之前学习过](http://ts.xcatliu.com/basics/type-of-function.html#接口中函数的定义)，可以使用接口的方式来定义一个函数需要符合的形状：
...
## 泛型类[§](http://ts.xcatliu.com/advanced/generics.html#泛型类)
...
## 泛型参数的默认类型[§](http://ts.xcatliu.com/advanced/generics.html#泛型参数的默认类型)
...
## 参考[§](http://ts.xcatliu.com/advanced/generics.html#参考)
...
## 函数的合并[§](http://ts.xcatliu.com/advanced/declaration-merging.html#函数的合并)

[之前学习过](http://ts.xcatliu.com/basics/type-of-function.html#重载)，我们可以使用重载定义多个函数类型：
...
## 接口的合并[§](http://ts.xcatliu.com/advanced/declaration-merging.html#接口的合并)
...
## 类的合并[§](http://ts.xcatliu.com/advanced/declaration-merging.html#类的合并)

类的合并与接口的合并规则一致。

## 参考[§](http://ts.xcatliu.com/advanced/declaration-merging.html#参考)
...
## 什么是代码检查[§](http://ts.xcatliu.com/engineering/lint.html#什么是代码检查)
...
## 为什么需要代码检查[§](http://ts.xcatliu.com/engineering/lint.html#为什么需要代码检查)
...
## 在 TypeScript 中使用 ESLint[§](http://ts.xcatliu.com/engineering/lint.html#在-typescript-中使用-eslint)

### 安装 ESLint[§](http://ts.xcatliu.com/engineering/lint.html#安装-eslint)
...
### 创建配置文件[§](http://ts.xcatliu.com/engineering/lint.html#创建配置文件)
...
### 检查一个 ts 文件[§](http://ts.xcatliu.com/engineering/lint.html#检查一个-ts-文件)
...
### 检查整个项目的 ts 文件[§](http://ts.xcatliu.com/engineering/lint.html#检查整个项目的-ts-文件)
...
### 在 VSCode 中集成 ESLint 检查[§](http://ts.xcatliu.com/engineering/lint.html#在-vscode-中集成-eslint-检查)
...
![VSCode ESLint 错误信息](http://ts.xcatliu.com/assets/vscode-eslint-error.png)
...
### 使用 Prettier 修复格式错误[§](http://ts.xcatliu.com/engineering/lint.html#使用-prettier-修复格式错误)
...
### 使用 AlloyTeam 的 ESLint 配置[§](http://ts.xcatliu.com/engineering/lint.html#使用-alloyteam-的-eslint-配置)
...
### 使用 ESLint 检查 tsx 文件[§](http://ts.xcatliu.com/engineering/lint.html#使用-eslint-检查-tsx-文件)

如果需要同时支持对 tsx 文件的检查，则需要对以上步骤做一些调整：

#### 安装 `eslint-plugin-react`[§](http://ts.xcatliu.com/engineering/lint.html#安装-eslint-plugin-react)

```
npm install --save-dev eslint-plugin-react
```

#### package.json 中的 scripts.eslint 添加 `.tsx` 后缀[§](http://ts.xcatliu.com/engineering/lint.html#packagejson-中的-scriptseslint-添加-tsx-后缀)
...
#### VSCode 的配置中新增 typescriptreact 检查[§](http://ts.xcatliu.com/engineering/lint.html#vscode-的配置中新增-typescriptreact-检查)
...
#### 使用 AlloyTeam ESLint 规则中的 TypeScript React 版本[§](http://ts.xcatliu.com/engineering/lint.html#使用-alloyteam-eslint-规则中的-typescript-react-版本)

[AlloyTeam ESLint 规则中的 TypeScript React 版本](https://github.com/AlloyTeam/eslint-config-alloy#typescript-react)

## Troubleshootings[§](http://ts.xcatliu.com/engineering/lint.html#troubleshootings)
...
### VSCode 没有显示出 ESLint 的报错[§](http://ts.xcatliu.com/engineering/lint.html#vscode-没有显示出-eslint-的报错)
...
![VSCode 的 ESLint 输出](http://ts.xcatliu.com/assets/vscode-output-eslint.png)

### 为什么有些定义了的变量（比如使用 `enum` 定义的变量）未使用，ESLint 却没有报错？[§](http://ts.xcatliu.com/engineering/lint.html#为什么有些定义了的变量比如使用-enum-定义的变量未使用eslint-却没有报错)
...
### 启用了 noUnusedParameters 之后，只使用了第二个参数，但是又必须传入第一个参数，这就会报错了[§](http://ts.xcatliu.com/engineering/lint.html#启用了-nounusedparameters-之后只使用了第二个参数但是又必须传入第一个参数这就会报错了)
...
| 选项                                                         | 类型      | 默认值  | 描述                                                         |
| :----------------------------------------------------------- | :-------- | :------ | :----------------------------------------------------------- |
| [`allowJs`](http://ts.xcatliu.com/engineering/compiler-options.html#allowjs) | `boolean` | `false` | 允许编译 js 文件                                             |
| [`allowSyntheticDefaultImports`](http://ts.xcatliu.com/engineering/compiler-options.html#allowsyntheticdefaultimports) | `boolean` | `false` | 允许对不包含默认导出的模块使用默认导入。这个选项不会影响生成的代码，只会影响类型检查。 |

## allowJs[§](http://ts.xcatliu.com/engineering/compiler-options.html#allowjs)
...
## allowSyntheticDefaultImports[§](http://ts.xcatliu.com/engineering/compiler-options.html#allowsyntheticdefaultimports)
...
当然，我们一般不会在 ts 文件中使用 `export = foo` 来导出模块，而是在[写（符合 commonjs 规范的）第三方库的声明文件](http://ts.xcatliu.com/basics/declaration-files#export-1)时，才会用到 `export = foo` 来导出类型。
